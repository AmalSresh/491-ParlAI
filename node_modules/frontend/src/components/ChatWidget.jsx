...
function getPageContext(pathname) {
  if (pathname.includes('/nfl'))
    return {
      sport: 'NFL',
      emoji: '🏈',
      description: 'NFL player props and season projections',
    };
  if (pathname.includes('/mlb'))
    return {
      sport: 'MLB',
      emoji: '⚾',
      description: 'MLB live game betting with moneyline and totals',
    };
  if (pathname.includes('/nba'))
    return {
      sport: 'NBA',
      emoji: '🏀',
      description: 'NBA matchups and game betting',
    };
  if (pathname.includes('/hockey'))
    return {
      sport: 'NHL',
      emoji: '🏒',
      description: 'NHL hockey live game betting',
    };
  if (pathname.includes('/soccer'))
    return {
      sport: 'Soccer',
      emoji: '⚽',
      description: 'Soccer match betting',
    };
  if (pathname.includes('/bets'))
    return {
      sport: 'My Bets',
      emoji: '📋',
      description: 'viewing your placed bets',
    };
...
function getSmartResponse(message, pageContext) {
  ...
  if (
    msg.includes('how') &&
    (msg.includes('bet') || msg.includes('place') || msg.includes('wager'))
  ) {
  ...
  if (
    msg.includes('moneyline') ||
    msg.includes('money line') ||
    (msg.includes('ml') && msg.includes('mean'))
  ) {
  ...
  if (
    msg.includes('spread') ||
    msg.includes('point spread') ||
    msg.includes('handicap')
  ) {
  ...
  if (
    ...
    (msg.includes('prop') && !msg.includes('promo'))
  ) {
  ...
  if (
    msg.includes('tip') ||
    msg.includes('strateg') ||
    msg.includes('advice') ||
    msg.includes('help me win') ||
    msg.includes('how to win')
  ) {
  ...
  if (
    ...
    msg.includes('current page') ||
    msg.includes('here') ||
    msg.includes('what am i')
  ) {
    ...
    return text.split('\n').map((line, i) => {
      ...
      return (
        <span key={i}>
          {parts.map((part, j) =>
            j % 2 === 1 ? (
              <strong key={j} style={{ color: '#00f6ff' }}>
                {part}
              </strong>
            ) : (
              part
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: isOpen
            ? '#0d0f14'
            : 'linear-gradient(135deg, #00f6ff, #0080c6)',
      ...
      {isOpen && (
        <div
          style={{
            ...
            borderRadius: '18px',
            boxShadow:
              '0 0 40px rgba(0,246,255,0.15), 0 20px 60px rgba(0,0,0,0.5)',
            display: 'flex',
              ...
              >
                ...
                <div
                  style={{
                    ...
                    lineHeight: 1.55,
                    border:
                      msg.role === 'assistant' ? '1px solid #1f2430' : 'none',
                  }}
                >
                  {formatText(msg.text)}
                </div>
            ...
            >
              {suggestions.map((s) => (
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.background = 'rgba(0,246,255,0.12)')
                  }
                  onMouseLeave={(e) =>
